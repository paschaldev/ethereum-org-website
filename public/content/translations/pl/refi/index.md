...
Projekty ReFi realizują te zasady przy użyciu [inteligentnych kontraktów](/glossary/#smart-contract) i aplikacji [zdecentralizowanych finansów (DeFi)](/glossary/#defi) w celu zachęcania do zachowań regeneracyjnych, np. przywracania zdegradowanych ekosystemów i ułatwiania współpracy na dużą skalę w kwestii globalnych problemów, takich jak zmiany klimatu i utrata różnorodności biologicznej.
...
Przejście VCM do nowego, opartego na blockchainie **cyfrowego rynku emisji CO2 (DCM)** może być okazją do ulepszenia istniejącej technologii walidacji, transakcji i konsumpcji kredytów węglowych. Blockchainy umożliwiają publiczną weryfikację danych, dostęp dla szerokiego grona użytkowników i większą płynność.
